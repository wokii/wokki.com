...
import LightBundle from "./LightBundle";

const badgeStyles =
  "relative isolate flex h-9 w-9 items-center justify-center rounded-full border border-foreground/20 bg-[color-mix(in_srgb,var(--accent)_10%,var(--background))] text-[11px] font-medium uppercase tracking-widest text-foreground/80 transition-all hover:border-accent/60 hover:text-accent";
...
const menuStyles =
  "fixed z-[70] w-[300px] rounded-[30px] border border-foreground/12 bg-[linear-gradient(165deg,color-mix(in_srgb,var(--accent)_6%,var(--background))_0%,var(--background)_45%,color-mix(in_srgb,var(--accent)_4%,var(--background))_100%)] p-5 text-xs shadow-[0_28px_90px_rgba(0,0,0,0.16)] backdrop-blur-xl transition-all duration-200 dark:border-accent/18 dark:shadow-[0_26px_80px_color-mix(in_srgb,var(--accent)_18%,transparent)]";
  ...
  if (!session) {
    ...
    return (
      ...
      >
        ...
        >
          <span className="relative z-10">O.S.</span>
        </button>
