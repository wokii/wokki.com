...
export default function AuthControls() {
  ...
  const rayOriginStyle = {
    "--ray-origin-x": "calc(100% - 18px)",
    "--ray-origin-y": "-30px",
    ...
    return (
      <div className="relative group before:absolute before:left-0 before:right-0 before:top-full before:h-3 before:content-['']">
        ...
        <div
          ...
          style={rayOriginStyle}
        >
          <div className="pointer-events-none absolute inset-0 -z-10 [background:repeating-conic-gradient(from_0deg_at_var(--ray-origin-x)_var(--ray-origin-y),rgba(255,255,255,0.55)_0deg_0.4deg,transparent_0.4deg_1deg)] [mask:radial-gradient(circle_at_var(--ray-origin-x)_var(--ray-origin-y),transparent_0_17px,#000_18px)] opacity-70" />
